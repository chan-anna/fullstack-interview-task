...
- `/investments/generate-report` get a csv report for all user investment holdings

To run tests in the admin service
...
- Relating to the task please add answers to the following questions;
  ...
  4. What else would you have liked to improve given more time?
     ...
     Add logging to better monitor the system

     Add test to cover cases such as missing data also testing the new route

     Error handling

Thank you for your time in looking through the code. I enjoyed this task :)
